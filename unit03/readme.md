...
2.	NoEce	the	==	operator	that’s	used	to compare	the	values	of	SEng	variables.
...
3.	Change	the	code	to	exit	the	loop	as		 soon	as	the	program	finds	and	prints	the	name		 MaElda.	Use	the	break	keyword	for	this.
